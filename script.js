...
function editButton() {
  ...
  enableValidation();
  hideInputError(popupFormProfile, nameInput)
  hideInputError(popupFormProfile, proffesionInput)
}
...
function addPlace() {
  ...
  hideInputError(popupFormPlace, placeNameInput)
  hideInputError(popupFormPlace, placeLinkInput)
}
